...
Executable contracts live under `docs/02 - Contracts/` (query, semantic search, relationship traversal, evidence tooling, procurement agent, materialization, records).
